...
Extend the queues activity to accommodate any passengers that in a wheelchair or an unaccompanied minor to skip the queue and be served immediately.
...
Make use of a custom priority queue data structure. 
